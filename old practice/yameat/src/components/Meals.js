  ...
  return (
    <div className='max-w-[1520px] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-center'>
            ...
            <button onClick={()=>filterCat("beef")} className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Beaf</button>
            <button onClick={()=>filterCat("seafood")} className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Seafood</button>
                ...
                foods.map((item)=>(
                    <div key={item.id} className='border-none hover:scale-105 duration-300'>
                        ...
                        <div className='flex justify-between py-2 px-2'>
                            <p className='font-bold overflow-hidden overflow-ellipsis whitespace-nowrap'>{item.title}</p>
